...
public class alter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_username = findViewById(R.id.et_alter_username);
        edit_password1 = findViewById(R.id.et_alter_pwd1);
        edit_password2 = findViewById(R.id.et_alter_pwd2);
        ...
        bt_alter =findViewById(R.id.bt_alter);    //绑定xml的按钮
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                String sql="update admin set password='"+pwd1+"' WHERE `username`= '"+user+"'";
